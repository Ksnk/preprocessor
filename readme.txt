...
Добавлен тег config в задачу PHING. Разумно для небольших конфигов, чтобы не заводить маленькие файлы.

##1.2##

 * добавлена функция clear в POINT
 * preprocessor::instance() - наконец-то не нужно больше использовать GLOBALS.
 * preprocessor::log - теперь статическая функция
 * ~ html2js - фильтр доработан до сложного html со скриптами и стилями. Фильтр чистит коментарии и лишние пробелы.
