...
~ рефакторинг кода. Изменена дисциплина работы с POINT. Теперь это класс POINT с
 фунциями start,finish,get вместо point_start,point_finisht,point, соответственно
 Добавлены функции
