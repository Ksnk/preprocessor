...
* [Рецепты](#toc8)
    ...
    * [Как вставить название и версию в текстовую строку внутри проекта.](#toc10)
    * [Ajax обработчик предполагает выдавать HTML клиенту.](#toc11)
    * [Вставить кусок файла в файл проекта](#toc12)
    * [Мой редактор не любит ASP-like теги и говорит, что это ошибки](#toc13)
    * [Добавить в проект документацию в виде txt и в виде html](#toc14)
    * [Мне нужно вставить кусок текста в комментарий](#toc15)
    * [В конце файла хочется поместить текст лицензионного соглашения](#toc16)
...
### <a name="toc10"/>Как вставить название и версию в текстовую строку внутри проекта.
...
### <a name="toc11"/>Ajax обработчик предполагает выдавать HTML клиенту.

Существующая схема доводки таких случаев предполагает, что отдаваемый HTML кусок будет вставлен прямо в строковую константу. К сожалению при этом сильно загруднена отладка и просмотр получившейся конструкции.
...
### <a name="toc12"/>Вставить кусок файла в файл проекта
...
### <a name="toc13"/>Мой редактор не любит ASP-like теги и говорит, что это ошибки
...
### <a name="toc14"/>Добавить в проект документацию в виде txt и в виде html
...
Токже, markdown является одним из языков разметки, автоматически обрабатываемых github'ом, так что принцип построения документации может быть таким:
...
### <a name="toc15"/>Мне нужно вставить кусок текста в комментарий
...
### <a name="toc16"/>В конце файла хочется поместить текст лицензионного соглашения
