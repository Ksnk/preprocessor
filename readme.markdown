...
Нужно добавить в config.xml строчки:
...
Значения version и licence - соответствующие поля шапки. Атрибут name последней строчки - путь до файла git.hat.xml, который идет с проектом. В файле описан примерный вид шапки, вставляемой в файлы, менять нужно имено там.
