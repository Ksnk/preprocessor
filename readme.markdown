...
* [Рецепты](#toc8)
    ...
    * [Вставить кусок файла в файл проекта](#toc10)
    * [Мой редактор не любит ASP-like теги и говорит, что это ошибки](#toc11)
    * [Мне нужно вставить кусок текста в комментарий](#toc12)
    * [В конце файла хочется поместить текст лицензионного соглашения](#toc13)
...
### <a name="toc10"/>Вставить кусок файла в файл проекта
...
### <a name="toc11"/>Мой редактор не любит ASP-like теги и говорит, что это ошибки
...
### <a name="toc12"/>Мне нужно вставить кусок текста в комментарий
...
### <a name="toc13"/>В конце файла хочется поместить текст лицензионного соглашения
